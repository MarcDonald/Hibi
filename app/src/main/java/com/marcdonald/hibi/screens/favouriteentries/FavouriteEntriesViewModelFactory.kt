...
class FavouriteEntriesViewModelFactory(private val entryRepository: EntryRepository,
	...
	override fun <T : ViewModel?> create(modelClass: Class<T>): T {
		return FavouriteEntriesViewModel(entryRepository, tagEntryRelationRepository, bookEntryRelationRepository) as T
	}
}