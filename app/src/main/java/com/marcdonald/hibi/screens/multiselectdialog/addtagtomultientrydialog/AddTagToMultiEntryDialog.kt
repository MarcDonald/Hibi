 ...
 */
package com.marcdonald.hibi.screens.multiselectdialog.addtagtomultientrydialog
...
class AddTagToMultiEntryDialog(private val selectedCount: Int,
	...
	private val viewModel by viewModels<AddTagToMultiEntryViewModel> { viewModelFactory }
