...
import app.marcdev.hibi.mainscreens.booksfragment.bookentriesfragment.BookEntriesViewModelFactory
import app.marcdev.hibi.mainscreens.booksfragment.mainbooksfragment.BooksFragmentViewModelFactory
import app.marcdev.hibi.mainscreens.calendarfragment.CalendarTabViewModelFactory
import app.marcdev.hibi.mainscreens.entryscreens.addentryscreen.AddEntryViewModelFactory
import app.marcdev.hibi.mainscreens.entryscreens.viewentryscreen.ViewEntryViewModelFactory
import app.marcdev.hibi.mainscreens.mainentries.MainEntriesViewModelFactory
import app.marcdev.hibi.mainscreens.searchentries.searchentriesscreen.SearchEntriesViewModelFactory
import app.marcdev.hibi.mainscreens.settings.backupdialog.BackupDialogViewModelFactory
import app.marcdev.hibi.mainscreens.settings.restoredialog.RestoreDialogViewModelFactory
import app.marcdev.hibi.mainscreens.settings.updatedialog.UpdateDialogViewModelFactory
import app.marcdev.hibi.mainscreens.tagsfragment.maintagsfragment.TagsFragmentViewModelFactory
import app.marcdev.hibi.mainscreens.tagsfragment.taggedentriesfragment.TaggedEntriesViewModelFactory
